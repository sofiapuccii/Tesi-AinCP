...
def test_classifiers(data_folder, save_folder, subjects_indexes):
    ...
    data = {
        "Estimators Number": estimators_number_list,
        "Correlation Coefficients": corrcoef_list,
        "R2 Scores": r2_score_list
    }

    # Writing to a JSON file
    with open(save_folder + 'classifiers_stats.json', 'w') as file:
        json.dump(data, file, indent=4)

    plt.savefig(save_folder + 'n_est_correlation.png')