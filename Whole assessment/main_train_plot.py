...
if not os.path.exists('Best_model/'+stats_folder):
    ...
    plot_dashboards(data_folder, save_folder='Best_model/', subjects_indexes=subjects_indexes, min_mean_test_score=min_mean_test_score, window_size=window_size, stats_folder=stats_folder)
